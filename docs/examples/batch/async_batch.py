from pydynox import BatchWriter, DynamoDBClient, Model, ModelConfig
...
async def main():
    # Async batch write with context manager (BatchWriter is async by default)
    ...
    # Async batch get - client level (batch_get is async by default)
    keys = [
