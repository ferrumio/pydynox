...
class S3Operations:
    ...
    # Sync methods - return tuples with metrics
    def upload_bytes(
        self,
        bucket: str,
        key: str,
    ...
    def download_bytes(self, bucket: str, key: str) -> tuple[bytes, S3Metrics]: ...
    def presigned_url(
        self, bucket: str, key: str, expires_secs: int = 3600
    ) -> tuple[str, S3Metrics]: ...
    def delete_object(self, bucket: str, key: str) -> S3Metrics: ...
    def head_object(self, bucket: str, key: str) -> tuple[S3Metadata, S3Metrics]: ...
    def save_to_file(self, bucket: str, key: str, path: str) -> tuple[int, S3Metrics]: ...

    # Async methods - return tuples with metrics
    ...
    def async_download_bytes(
        self, bucket: str, key: str
    ) -> Coroutine[Any, Any, tuple[bytes, S3Metrics]]: ...
    def async_presigned_url(
        self, bucket: str, key: str, expires_secs: int = 3600
    ) -> Coroutine[Any, Any, tuple[str, S3Metrics]]: ...
    def async_delete_object(self, bucket: str, key: str) -> Coroutine[Any, Any, S3Metrics]: ...
    def async_head_object(
        self, bucket: str, key: str
    ) -> Coroutine[Any, Any, tuple[S3Metadata, S3Metrics]]: ...
    def async_save_to_file(
